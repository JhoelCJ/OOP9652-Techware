...
public class FixedExpenseDB {
    public static void createDocument() {
        ...
        try (MongoClient mongoClient = MongoClients.create(uri)) {
            ...
            MongoCollection<Document> collection = database.getCollection("fixedExpense");
            ...
            Document doc1 = new Document("id", id).append("argument", argument).append("amount", amount);
    ...
    public static void showDatabase() {
        ...
        try (MongoClient mongoClient = MongoClients.create(uri)) {
            ...
            MongoCollection<Document> collection = 
                    database.getCollection("fixedExpense");
